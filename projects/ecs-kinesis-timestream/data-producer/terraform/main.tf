...
resource "aws_iam_policy" "kds_put_event_role_policy" {
    name = "${var.project_name}-${var.service}-kds-put-events-policy"
    policy = data.aws_iam_policy_document.kds_put_event_role_policy.json
    tags = {
...
resource "aws_iam_role_policy_attachment" "kds_put_event_role_policy_attach" {
    role = aws_iam_role.ecsTaskExecutionRole.name
    policy_arn = aws_iam_policy.kds_put_event_role_policy.arn
}
